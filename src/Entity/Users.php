...
class Users implements UserInterface, Serializable
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="Password", message="Les mots de passe ne correspondent pas, veiller entrer le memes mot de passes")
    ...
    /**
     * @var File|null
     * @Vich\UploadableField(mapping="users_profil_image", fileNameProperty="ProfilFileName")
     */
    private $ImageFile;
